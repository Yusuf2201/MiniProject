...
import com.yusuf.project.service.CustomUserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	AuthenticationSuccessHandler googleoAuth2SuccesHandler;
	@Override
	protected void configure(HttpSecurity http) throws Exception {
		...
		.loginPage("/login")
		//ini juga beda 
		.successHandler(googleoAuth2SuccesHandler)
		.and()
		.logout()
